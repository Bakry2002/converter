...
exports.converters = exports.PresentationConverter = void 0;
...
// ==========================================================================================
// ==========================================================================================
class PresentationConverter extends types_1.Converter {
    constructor() {
        super(...arguments);
    ...
    inputOptions() {
        var _a, _b;
        return `${(_b = (_a = this.fromNode.options) === null || _a === void 0 ? void 0 : _a.inputs) !== null && _b !== void 0 ? _b : ''} ${(0, file_1.mimeToFileExtension)(this.to)}`;
    }
    output() {
    ...
    async execute() {
        console.log(`${process.env.NODE_ENV === 'development'
            ? libreOfficePath
            : 'soffice'} --convert-to ${this.inputOptions()} ${this.input()} ${this.outputOptions()}`);
        console.log('===============================');
        await exec(`${process.env.NODE_ENV === 'development'
            ? libreOfficePath
            : 'soffice'} --convert-to ${this.inputOptions()} ${this.input()} ${this.outputOptions()}`, { cwd: this.cwd });
    }
    async postConvert() { }
    async preRead() { }
    async read() {
...
exports.PresentationConverter = PresentationConverter;
