...
const Hero: React.FC<HeroProps> = ({}) => {
    return (
        <section className="relative min-h-screen bg-hero-bg bg-no-repeat bg-cover">
            <div className="flex items-center xmd:gap-0 gap-12 flex-col justify-between top-0 left-0 w-full min-h-screen bg-black/40 xl:pt-[calc(75px+150px)] pt-[calc(75px+100px)]">
